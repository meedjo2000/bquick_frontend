const customTheme = {
    ...
    sidebar: {
        ...
        item: {
            base: "flex items-center justify-center rounded-3xl px-4 py-3 mb-1 gap-3  text-[15px] text-start  leading-[normal] font-normal text-link hover:bg-lightprimary hover:text-primary dark:text-white  dark:hover:text-primary",
            content: {
        ...
        collapse: {
            button:
                "group flex gap-3 items-center rounded-3xl px-4 py-3 mb-1 text-[15px] text-start truncate leading-[normal] font-normal text-link hover:bg-lightprimary hover:text-primary dark:text-white w-full dark:hover:text-primary",
            icon: {
