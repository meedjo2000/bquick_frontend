...
export default function SecurityList() {
    ...
    const getEmployeeFormattedList = (response: AxiosResponse, setOpenModal: (open: boolean) => void, type: string) => {
        ...
        toast.success(t('INFORMATION.SUCCESS_TITLE'), {
            description: t(type === 'add' ? 'Security.EMPLOYEE_ADD_SUCCESS' : 'Security.EMPLOYEE_UPDATE_SUCCESS'),
        });
    ...
    const columnsData = useMemo(() => getUsersColumns({onEdit, onDelete, t}), [onDelete, onEdit, t]);
